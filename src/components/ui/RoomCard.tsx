  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        rotateY: 2,
        boxShadow:
          "0 25px 50px -12px rgb(0 0 0 / 0.25), 0 0 40px rgb(245 158 11 / 0.1)",
      }}
      whileTap={{ scale: 0.98 }}
      transition={{
        type: "spring",
    ...
    >
      ...
      <div className="relative w-full h-64 overflow-hidden rounded-t-2xl">
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <motion.div className="flex items-center gap-1" whileHover={{ x: 2 }}>
            <Star size={12} className="fill-current" />€{price} / night
          </motion.div>
        </motion.div>
